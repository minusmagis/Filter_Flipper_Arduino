...
//    delay(500);
  ...
  if (Command == "60535468"  ||  Command == "28535468"  || Command == "28212236")                           //If The command is Left or left turn the left filter on
  {
  ...
  else if (Command == "6657555668"  ||  Command == "3457555668"  ||  Command == "3425232436")                          // If the master asks for the "homed" status send the homed status
  {
...
String readCommand() {
  if (Serial.available() > 0)
  {
    ...
    delay(100);                                                    // Small delay to allow for the serial to buffer all the data
